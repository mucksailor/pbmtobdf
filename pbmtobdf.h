...
#define BLOCKS \
	...
	X(COMBINING_DIACRITICAL_MARKS, "combining_diacritical_marks", 0x0300, 0x0370) \
	...
	X(UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS, "unified_canadian_aboriginal_syllabics", 0x1400, 0x1680) \
	...
	X(UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED, "unified_canadian_aboriginal_syllabics_extended", 0x18b0, 0x1900) \
	...
	X(COMBINING_DIACRITICAL_MARKS_EXTENDED, "combining_diacritical_marks_extended", 0x1ab0, 0x1b00) \
	...
	X(PHONETIC_EXTENSIONS_SUPPLEMENT, "phonetic_extensions_supplement", 0x1d80, 0x1dc0) \
	X(COMBINING_DIACRITICAL_MARKS_SUPPLEMENT, "combining_diacritical_marks_supplement", 0x1dc0, 0x1e00) \
	...
	X(SUPERSCRIPTS_AND_SUBSCRIPTS, "superscripts_and_subscripts", 0x2070, 0x20a0) \
	X(CURRENCY_SYMBOLS, "currency_symbols", 0x20a0, 0x20d0) \
	X(COMBINING_DIACRITICAL_MARKS_FOR_SYMBOLS, "combining_diacritical_marks_for_symbols", 0x20d0, 0x2100) \
	...
	X(OPTICAL_CHARACTER_RECOGNITION, "optical_character_recognition", 0x2440, 0x2460) \
	...
	X(MISCELLANEOUS_MATHEMATICAL_SYMBOLS_A, "miscellaneous_mathematical_symbols-a", 0x27c0, 0x27f0) \
	...
	X(MISCELLANEOUS_MATHEMATICAL_SYMBOLS_B, "miscellaneous_mathematical_symbols-b", 0x2980, 0x2a00) \
	X(SUPPLEMENTAL_MATHEMATICAL_OPERATORS, "supplemental_mathematical_operators", 0x2a00, 0x2b00) \
	X(MISCELLANEOUS_SYMBOLS_AND_ARROWS, "miscellaneous_symbols_and_arrows", 0x2b00, 0x2c00) \
	...
	X(IDEOGRAPHIC_DESCRIPTION_CHARACTERS, "ideographic_description_characters", 0x2ff0, 0x3000) \
	X(CJK_SYMBOLS_AND_PUNCTUATION, "cjk_symbols_and_punctuation", 0x3000, 0x3040) \
	...
	X(KATAKANA_PHONETIC_EXTENSIONS, "katakana_phonetic_extensions", 0x31f0, 0x3200) \
	X(ENCLOSED_CJK_LETTERS_AND_MONTHS, "enclosed_cjk_letters_and_months", 0x3200, 0x3300) \
	X(CJK_COMPATIBILITY, "cjk_compatibility", 0x3300, 0x3400) \
	X(CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A, "cjk_unified_ideographs_extension-a", 0x3400, 0x4dc0) \
	...
	X(HIGH_PRIVATE_USE_SURROGATES, "high_private_use_surrogates", 0xdb80, 0xdc00) \
	X(LOW_SURROGATES, "low_surrogates", 0xdc00, 0xe000) \
	X(PRIVATE_USE_AREA, "private_use_area", 0xe000, 0xf900) \
	X(CJK_COMPATIBILITY_IDEOGRAPHS, "cjk_compatibility_ideographs", 0xf900, 0xfb00) \
	X(ALPHABETIC_PRESENTATION_FORMS, "alphabetic_presentation_forms", 0xfb00, 0xfb50) \
	X(ARABIC_PRESENTATION_FORMS_A, "arabic_presentation_forms-a", 0xfb50, 0xfe00) \
	...
	X(ARABIC_PRESENTATION_FORMS_B, "arabic_presentation_forms-b", 0xfe70, 0xff00) \
	X(HALFWIDTH_AND_FULLWIDTH_FORMS, "halfwidth_and_fullwidth_forms", 0xff00, 0xfff0) \
